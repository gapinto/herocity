...
export class PrismaRestaurantRepository implements IRestaurantRepository {
  ...
  async findById(id: string): Promise<Restaurant | null> {
    ...
    return Restaurant.fromPersistence({
      ...
      incomeValue: data.incomeValue ?? undefined,
      allowKitchenNotifyBeforePayment: data.allowKitchenNotifyBeforePayment ?? false,
      timezone: data.timezone || undefined,
      openingHours: (data.openingHours as any) || undefined,
  ...
  async findAll(): Promise<Restaurant[]> {
    ...
    return data.map((item) =>
      Restaurant.fromPersistence({
        ...
        incomeValue: item.incomeValue ?? undefined,
        allowKitchenNotifyBeforePayment: item.allowKitchenNotifyBeforePayment ?? false,
        timezone: item.timezone || undefined,
        openingHours: (item.openingHours as any) || undefined,
  ...
  async save(restaurant: Restaurant): Promise<Restaurant> {
    const data: any = {
      ...
      incomeValue: restaurant.getIncomeValue() ?? null,
      allowKitchenNotifyBeforePayment: restaurant.getAllowKitchenNotifyBeforePayment(),
      timezone: restaurant.getTimezone() ?? null,
      openingHours: restaurant.getOpeningHours() ?? null,
    ...
    return Restaurant.fromPersistence({
      ...
      incomeValue: saved.incomeValue ?? undefined,
      allowKitchenNotifyBeforePayment: saved.allowKitchenNotifyBeforePayment ?? false,
      timezone: saved.timezone || undefined,
      openingHours: (saved.openingHours as any) || undefined,
